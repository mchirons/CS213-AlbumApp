 ...
 */
public class ResultsPhotoEditScreen extends AppCompatActivity {

    private static final String TAG = AlbumScreen.class.getSimpleName();

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.resultseditphoto_screen);
        loadData();

        Photo photo = HomeScreen.results.get(ResultsScreen.currentPhoto);
        ...
        // Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<Tag> adapter1 = new ArrayAdapter<Tag>(ResultsPhotoEditScreen.this, android.R.layout.simple_spinner_item, photo.getTags());
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < input.length; i++) {
                    ...
                    if (!photo.getTags().contains(tag)) {
                        photo.addTag(tag);
                        Log.d(TAG, "Tag added");
                        Toast.makeText(ResultsPhotoEditScreen.this, "Tag added", Toast.LENGTH_SHORT).show();
                    }
                }
                saveData();
                finish();
                Intent intent = new Intent(ResultsPhotoEditScreen.this, ResultsPhotoEditScreen.class);
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photo.getTags().size() >= 0){
                    photo.deleteTag(tag);
                    Toast.makeText(ResultsPhotoEditScreen.this, "Tag deleted", Toast.LENGTH_SHORT).show();
                    saveData();
                    finish();
                    Intent intent = new Intent(ResultsPhotoEditScreen.this, ResultsPhotoEditScreen.class);
                    startActivity(intent);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                saveData();
                finish();
                Intent intent = new Intent(ResultsPhotoEditScreen.this, ResultsPhotoScreen.class);
                startActivity(intent);
